...
template.app-sync-status: |
  message: |
    ...
    Application details: https://argo.devops.seraitrade.net/applications/{{.app.metadata.name}}.
  slack:
    attachments: |
      [{
        "title": "{{.app.metadata.name}}",
        "title_link": "https://argo.devops.seraitrade.net/applications/{{.app.metadata.name}}",
        "color": "#18be52",
        "fields": [{
          "title": "Sync Status",
